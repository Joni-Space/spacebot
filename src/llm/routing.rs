...
impl Default for RoutingConfig {
    fn default() -> Self {
        Self {
            channel: "anthropic/claude-sonnet-4-5-20250514".into(),
            branch: "anthropic/claude-sonnet-4-5-20250514".into(),
            ...
            fallbacks: HashMap::from([(
                "anthropic/claude-sonnet-4-5-20250514".into(),
                vec!["anthropic/claude-sonnet-4-20250514".into(), "anthropic/claude-haiku-4.5-20250514".into()],
            )]),
...
pub fn defaults_for_provider(provider: &str) -> RoutingConfig {
    match provider {
        "openrouter" => {
            let channel: String = "openrouter/anthropic/claude-sonnet-4-5-20250514".into();
            let worker: String = "openrouter/anthropic/claude-haiku-4.5-20250514".into();
            RoutingConfig {
                channel: "openrouter/anthropic/claude-sonnet-4-5-20250514".into(),
                branch: "openrouter/anthropic/claude-sonnet-4-5-20250514".into(),
